...
emissions_long_subset = emissions_long_1990_2022.query("country.isin(['Kenya','Nigeria','Egypt','South Africa','Ghana'])")
...
tickvals = np.linspace(-2.17, 10600, 50)

# Modify the colorbar to have more divisions
fig_map.update_coloraxes(
    colorbar=dict(
        tickmode="array",  # This allows you to specify custom tick values
        tickvals= tickvals,  # Example tick values, adjust as needed
        ticktext=["0", "50", "100", "150", "200", "250"]  # Corresponding text for the ticks
    )
)
